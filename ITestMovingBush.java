...
class ImageComponent extends JComponent
{
	...
	public int k=1;
        public int score =0;
	public Float wr=100.0f;public Float wl=100.0f;
        Date d=new Date();
...
{ 
	...
	int bushHeight = bush.getHeight(this);
        ...
        }y1=y1-1;if (y>=y1 && y<=(bushHeight+y1)&&f==1)
	{System.out.println("1");
		x=x1+bushWidth;
		f=0;
	}//bw=bush+x1;
	if(x>=x1 && x<=(bushWidth+x1) && f==1)
	{//if( y>=y1 && y<=(bushHeight+y1)
	System.out.println("2");
		y=y1+bushHeight+1;
		f=0;
	}/*}if(f==1)
{if(x>=x1 && x<=(bushWidth+x1) && f==1){System.out.println("2");
		y=y1+bushHeight+1;
		f=0;}else{System.out.println("1");
		x=x1+bushWidth;
		f=0;}}*/
